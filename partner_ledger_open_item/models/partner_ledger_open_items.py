...
class ReportPartnerLedgerOpenItems(models.AbstractModel):
    _inherit = "account.report"
    _name = "account.partner.ledger.open.items"
    _description = "Partner Ledger open items"
    ...
    def _get_templates(self):
        templates = super(ReportPartnerLedgerOpen, self)._get_templates()
    ...
    def _get_options_domain(self, options):
        ...
        domain = super(ReportPartnerLedgerOpen, self)._get_options_domain(options)
    ...
    def _get_report_name(self):
        return _('Partner Ledger Open Items')
